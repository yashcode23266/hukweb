...
const legalContent = {
  en: {
    privacy: {
      ...
      intro:
        'We collect only the information needed to manage merchandise orders, receipts, gallery/admin records, and communication with devotees.',
      sections: [
        ['Information We Collect', 'Name, phone number, email, address, order details, payment references, and admin activity records where required.'],
        ['How We Use It', 'To process orders, generate receipts, support devotees, maintain records, and improve the website experience.'],
    ...
    terms: {
      ...
      intro:
        'By using this website, you agree to use it respectfully for devotional, merchandise, gallery, and community information purposes.',
      sections: [
        ['Website Use', 'Do not misuse forms, attempt unauthorized admin access, upload harmful content, or disrupt the website.'],
        ['Orders', 'Shop payments must use accurate details. Orders and receipts depend on successful payment confirmation.'],
    ...
    refund: {
      ...
      sections: [
        ...
        ['How To Request', 'Contact the mandal with your name, phone number, amount, order reference, and payment proof.'],
  ...
  mr: {
    privacy: {
      label: 'गोपनीयता धोरण',
      title: 'गोपनीयता धोरण',
      description: 'भक्त, ऑर्डर आणि प्रशासनाशी संबंधित माहिती कशी वापरली जाते.',
      intro:
        'दुकान ऑर्डर, पावत्या, गॅलरी/अॅडमिन नोंदी आणि भक्तांशी संपर्कासाठी आवश्यक तेवढीच माहिती घेतली जाते.',
      sections: [
        ['आम्ही कोणती माहिती घेतो', 'नाव, फोन नंबर, ईमेल, पत्ता, ऑर्डर तपशील, पेमेंट संदर्भ आणि आवश्यक अॅडमिन नोंदी.'],
        ['माहितीचा वापर', 'ऑर्डर प्रक्रिया, पावती निर्मिती, भक्तांना मदत, नोंदी ठेवणे आणि वेबसाइट अनुभव सुधारण्यासाठी.'],
    ...
    terms: {
      label: 'नियम व अटी',
      title: 'नियम व अटी',
      description: 'वेबसाइट, दुकान आणि अॅडमिन सुविधांसाठी वापर अटी.',
      intro:
        'ही वेबसाइट भक्ती, वस्तू खरेदी, गॅलरी आणि मंडळ माहिती यासाठी आदराने वापरणे अपेक्षित आहे.',
      sections: [
        ['वेबसाइट वापर', 'फॉर्मचा गैरवापर, अनधिकृत अॅडमिन प्रवेश, हानिकारक सामग्री अपलोड किंवा वेबसाइटमध्ये अडथळा आणू नये.'],
        ['ऑर्डर', 'दुकान पेमेंटसाठी योग्य तपशील द्यावेत. ऑर्डर आणि पावती यशस्वी पेमेंटवर अवलंबून असतात.'],
    ...
    refund: {
      label: 'रिफंड धोरण',
      title: 'रिफंड धोरण',
      description: 'दुकान ऑर्डरसाठी रिफंड व रद्द करण्याचे मार्गदर्शन.',
      intro:
        'रिफंड पेमेंट स्थिती आणि ऑर्डर स्थितीवर अवलंबून काळजीपूर्वक हाताळले जातात.',
      sections: [
        ...
        ['विनंती कशी करावी', 'नाव, फोन नंबर, रक्कम, ऑर्डर संदर्भ आणि पेमेंट पुरावा मंडळाला द्या.'],
